...
struct TargetImplementation {
  ...
  static Score smith_waterman_affine_score(
    ...
    const auto prepared = prepare_alignment(
        ...
        gap_extend_score,
        width);
    return affine_scalable_kernel::detail::dispatch_score<SimdOps, true>(
        prepared,
        match_score,
        mismatch_score,
        gap_open_score,
  ...
  static AlignmentResult smith_waterman_affine_path(
    ...
    const auto prepared = prepare_alignment(
        ...
        gap_extend_score,
        width);
    return affine_scalable_kernel::detail::dispatch_traceback<SimdOps, true>(
        prepared,
        match_score,
        mismatch_score,
        gap_open_score,
  ...
  static Score needleman_wunsch_affine_score(
    ...
    const auto prepared = prepare_alignment(
        ...
        gap_extend_score,
        width);
    return affine_scalable_kernel::detail::dispatch_score<SimdOps, false>(
        prepared,
        match_score,
        mismatch_score,
        gap_open_score,
  ...
  static AlignmentResult needleman_wunsch_affine_path(
    ...
    const auto prepared = prepare_alignment(
        ...
        gap_extend_score,
        width);
    return affine_scalable_kernel::detail::dispatch_traceback<SimdOps, false>(
        prepared,
        match_score,
        mismatch_score,
        gap_open_score,
