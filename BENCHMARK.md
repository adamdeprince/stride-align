...
| rapidfuzz shim full surface (Intel avx10) | `x86_avx10_512` | rapidfuzz | 108 | 0.94x | 1.13x | 0.20x | 3.13x |
| rapidfuzz shim full surface (Mac M-series) | `macos_arm64_neon` | rapidfuzz | 108 | 0.98x | 1.23x | 0.15x | 2.08x |
| rapidfuzz shim full surface (Loongson) | `linux_loongarch64_lasx` | rapidfuzz (scalar fallback) | 108 | **49.17x** | 53.48x | 8.51x | 314.31x |
...
## rapidfuzz shim full surface (cross-arch) - 2026-06-10
...
workload. `rapidfuzz 3.14.5` on all three hosts.

### At a glance

| Host | Backend | Rows | Geomean | Median | Worst | Best | Wins/Ties/Losses |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| avx10 (Intel AWS, _avx10_512) | `_avx10_512` | 108 | **0.94x** | 1.13x | 0.2x | 3.13x | 60/4/44 |
| Mac M-series (_macos_arm64_neon) | `_macos_arm64_neon` | 108 | **0.98x** | 1.23x | 0.15x | 2.08x | 76/1/31 |
| Loongson (_lasx) | `_lasx` | 108 | **49.17x** | 53.48x | 8.51x | 314.31x | 108/0/0 |
...
`ratio = upstream / shim` per host (bold = upstream is faster).

| Workload | avx10 (`_avx10_512`) | Mac (`_macos_arm64_neon`) | Loongson (`_lasx`) |
| --- | ---: | ---: | ---: |
| distance.DamerauLevenshtein.distance_K2 | **0.702x** | 1.198x | 51.65x |
| distance.DamerauLevenshtein.distance_K3 | **0.538x** | 1.137x | 51.07x |
| distance.DamerauLevenshtein.distance_K4 | **0.835x** | 1.165x | 50.10x |
| distance.DamerauLevenshtein.distance_medium | **0.678x** | 1.234x | 52.32x |
| distance.DamerauLevenshtein.distance_short | 1.602x | 1.215x | 46.54x |
| distance.DamerauLevenshtein.normalized_distance_medium | **0.588x** | 1.235x | 52.18x |
| distance.DamerauLevenshtein.normalized_distance_short | 1.674x | 1.330x | 45.03x |
| distance.DamerauLevenshtein.normalized_similarity_medium | **0.754x** | 1.235x | 52.03x |
| distance.DamerauLevenshtein.normalized_similarity_short | **0.837x** | 1.288x | 45.10x |
| distance.DamerauLevenshtein.similarity_medium | **0.708x** | 1.209x | 52.25x |
| distance.DamerauLevenshtein.similarity_short | 1.516x | 1.201x | 45.77x |
| distance.Hamming.distance_equal_medium | **0.671x** | **0.863x** | 30.46x |
| distance.Hamming.distance_equal_short | **0.836x** | **0.790x** | 14.70x |
| distance.Hamming.normalized_distance_equal_medium | 1.328x | 1.944x | 30.27x |
| distance.Hamming.normalized_distance_equal_short | 1.695x | 2.010x | 17.59x |
| distance.Hamming.normalized_similarity_equal_medium | 1.359x | 1.850x | 35.11x |
| distance.Hamming.normalized_similarity_equal_short | 1.675x | 2.037x | 23.12x |
| distance.Hamming.similarity_equal_medium | **0.682x** | **0.854x** | 32.68x |
| distance.Hamming.similarity_equal_short | **0.782x** | **0.768x** | 17.48x |
| distance.Indel.distance_K2 | 1.206x | 1.004x | 68.14x |
| distance.Indel.distance_K3 | 1.165x | 0.960x | 58.92x |
| distance.Indel.distance_K4 | 1.408x | 0.956x | 48.30x |
| distance.Indel.distance_medium | 1.261x | 1.084x | 65.94x |
| distance.Indel.distance_short | 1.251x | 1.292x | 31.08x |
| distance.Indel.normalized_distance_medium | 1.673x | 1.403x | 60.77x |
| distance.Indel.normalized_distance_short | 2.738x | 1.806x | 28.88x |
| distance.Indel.normalized_similarity_medium | 1.777x | 1.446x | 64.70x |
| distance.Indel.normalized_similarity_short | 2.891x | 1.922x | 33.04x |
| distance.Indel.similarity_medium | 1.182x | 1.072x | 66.12x |
| distance.Indel.similarity_short | 1.123x | 1.265x | 32.00x |
| distance.Jaro.distance_medium | **0.268x** | **0.155x** | 25.52x |
| distance.Jaro.distance_short | 2.231x | 1.658x | 54.64x |
| distance.Jaro.normalized_distance_medium | **0.339x** | **0.159x** | 25.56x |
| distance.Jaro.normalized_distance_short | 1.692x | 1.650x | 54.75x |
| distance.Jaro.normalized_similarity_medium | **0.301x** | **0.161x** | 25.46x |
| distance.Jaro.normalized_similarity_short | **0.811x** | 1.669x | 52.65x |
| distance.Jaro.similarity_medium | **0.303x** | **0.158x** | 25.43x |
| distance.Jaro.similarity_short | 1.225x | 1.677x | 53.47x |
| distance.JaroWinkler.distance_medium | **0.305x** | **0.151x** | 25.84x |
| distance.JaroWinkler.distance_short | 1.175x | 1.609x | 59.88x |
| distance.JaroWinkler.normalized_distance_medium | **0.576x** | **0.156x** | 25.89x |
| distance.JaroWinkler.normalized_distance_short | 1.194x | 1.622x | 59.76x |
| distance.JaroWinkler.normalized_similarity_medium | **0.200x** | **0.160x** | 25.79x |
| distance.JaroWinkler.normalized_similarity_short | **0.787x** | 1.625x | 59.06x |
| distance.JaroWinkler.similarity_medium | **0.219x** | **0.161x** | 25.75x |
| distance.JaroWinkler.similarity_short | 1.389x | 1.601x | 58.24x |
| distance.LCSseq.distance_K2 | 1.180x | 0.991x | 68.76x |
| distance.LCSseq.distance_K3 | 1.165x | 0.988x | 58.86x |
| distance.LCSseq.distance_K4 | 1.383x | 0.954x | 48.42x |
| distance.LCSseq.distance_medium | 1.258x | 1.093x | 65.69x |
| distance.LCSseq.distance_short | 1.085x | 1.277x | 30.48x |
| distance.LCSseq.normalized_distance_medium | 1.708x | 1.434x | 62.30x |
| distance.LCSseq.normalized_distance_short | 1.787x | 1.924x | 29.66x |
| distance.LCSseq.normalized_similarity_medium | 1.567x | 1.385x | 62.08x |
| distance.LCSseq.normalized_similarity_short | 2.795x | 1.779x | 31.21x |
| distance.LCSseq.similarity_medium | 1.314x | 1.088x | 64.81x |
| distance.LCSseq.similarity_short | 1.133x | 1.234x | 29.04x |
| distance.Levenshtein.distance_K2 | 2.223x | 1.601x | 132.0x |
| distance.Levenshtein.distance_K3 | 1.980x | 1.927x | 100.8x |
| distance.Levenshtein.distance_K4 | 1.981x | 2.077x | 96.31x |
| distance.Levenshtein.distance_medium | 1.173x | 1.283x | 141.5x |
| distance.Levenshtein.distance_short | 0.935x | 1.401x | 63.50x |
| distance.Levenshtein.normalized_distance_medium | 1.347x | 1.472x | 136.5x |
| distance.Levenshtein.normalized_distance_short | 1.346x | 1.862x | 59.69x |
| distance.Levenshtein.normalized_similarity_medium | 1.396x | 1.494x | 140.1x |
| distance.Levenshtein.normalized_similarity_short | 1.812x | 1.942x | 64.82x |
| distance.Levenshtein.similarity_medium | 1.147x | 1.277x | 142.7x |
| distance.Levenshtein.similarity_short | 1.103x | 1.370x | 65.76x |
| distance.OSA.distance_K2 | 1.549x | 1.738x | 145.8x |
| distance.OSA.distance_K3 | 2.680x | 1.890x | 107.6x |
| distance.OSA.distance_K4 | 0.930x | 1.440x | 62.09x |
| distance.OSA.distance_medium | 0.978x | 1.235x | 157.6x |
| distance.OSA.distance_short | 2.025x | 1.296x | 70.24x |
| distance.OSA.normalized_distance_medium | 1.083x | 1.368x | 142.7x |
| distance.OSA.normalized_distance_short | 1.147x | 1.478x | 55.76x |
| distance.OSA.normalized_similarity_medium | 1.060x | 1.344x | 140.5x |
| distance.OSA.normalized_similarity_short | 1.213x | 1.541x | 55.68x |
| distance.OSA.similarity_medium | 0.911x | 1.156x | 152.3x |
| distance.OSA.similarity_short | **0.452x** | 1.070x | 63.17x |
| fuzz.QRatio_medium | 1.664x | 1.406x | 68.64x |
| fuzz.QRatio_short | 1.664x | 1.888x | 38.71x |
| fuzz.WRatio_medium | **0.362x** | **0.426x** | 35.26x |
| fuzz.WRatio_short | **0.560x** | **0.503x** | 10.94x |
| fuzz.partial_ratio_medium | **0.746x** | 0.972x | 76.84x |
| fuzz.partial_ratio_short | 1.362x | 1.338x | 36.78x |
| fuzz.partial_token_ratio_medium | **0.386x** | **0.505x** | 35.67x |
| fuzz.partial_token_ratio_short | **0.468x** | **0.691x** | 13.57x |
| fuzz.partial_token_set_ratio_medium | **0.701x** | 0.936x | 69.82x |
| fuzz.partial_token_set_ratio_short | 1.612x | 1.173x | 24.40x |
| fuzz.partial_token_sort_ratio_medium | **0.697x** | 0.964x | 71.86x |
| fuzz.partial_token_sort_ratio_short | **0.473x** | 1.137x | 27.48x |
| fuzz.ratio_medium | 1.698x | 1.455x | 68.23x |
| fuzz.ratio_short | 3.132x | 1.971x | 39.43x |
| fuzz.token_ratio_medium | **0.214x** | **0.368x** | 9.749x |
| fuzz.token_ratio_short | **0.784x** | **0.530x** | 9.572x |
| fuzz.token_set_ratio_medium | **0.344x** | **0.501x** | 9.283x |
| fuzz.token_set_ratio_short | **0.502x** | **0.744x** | 8.514x |
| fuzz.token_sort_ratio_medium | **0.341x** | **0.395x** | 9.340x |
| fuzz.token_sort_ratio_short | 0.874x | **0.539x** | 8.891x |
| process.cdist_50x100_Indel_distance | **0.344x** | **0.456x** | 169.7x |
| process.cdist_50x100_Jaro_similarity | **0.479x** | **0.737x** | 278.4x |
| process.cdist_50x100_Levenshtein_distance | **0.609x** | **0.742x** | 314.3x |
| process.cdist_50x100_OSA_distance | **0.628x** | **0.733x** | 298.9x |
| process.cdist_50x100_fuzz_ratio | **0.381x** | **0.524x** | 191.9x |
| process.extract_10k_Indel_distance | **0.696x** | **0.542x** | 74.57x |
| process.extract_10k_Levenshtein_distance | 1.170x | **0.752x** | 185.6x |
| process.extract_10k_fuzz_WRatio | **0.305x** | **0.399x** | 15.01x |
| process.extract_10k_fuzz_ratio | **0.663x** | **0.542x** | 92.70x |
