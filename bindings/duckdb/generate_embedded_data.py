#!/usr/bin/env python3
"""Generate deterministic C++ data for a self-contained native adapter.

The output is derived from the same Python matrix objects and BMPM text
resources used by the other adapters, so packages cannot silently drift to
different catalogs. Build-local consumers may ignore it; adapters distributed
as source may track it.
"""
...
def main() -> int:
    ...
    lines = [
        "// Generated by bindings/duckdb/generate_embedded_data.py; do not edit.",
        "#pragma once",
        "#include <cstdint>",
        "#include <string>",
